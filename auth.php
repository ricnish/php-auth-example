...
function authAPI()
{
  ...
  if(empty($user) || empty($pass) || !isValidyUser($user, $pass))
  {
...
function isValidyUser($user, $pass)
{
  if(!empty($_SESSION['authenticated_api']) && !empty($_SESSION['userlogin']) && $_SESSION['userlogin'] === $user)
  {
    return true;
  }
